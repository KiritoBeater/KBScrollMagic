...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KBScrollMagic.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liuxingqipan/KBScrollMagic'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liuxingqipan' => '1353137283@qq.com' }
  s.source           = { :git => 'https://github.com/liuxingqipan/KBScrollMagic.git', :tag => s.version.to_s }
